...
public class StageCreate6 : MonoBehaviour
{
    //初期値
    float x = 0.6f;
    float y = -2.0f;
    ...
    void Start()
    {
        ...
        Instantiate(NoBreakBlock, new Vector3(x + 2.4f, y, 0.0f), Quaternion.identity);
        ...
        Instantiate(NoBreakBlock, new Vector3(x - 3.6f, y, 0.0f), Quaternion.identity);
        ...
        Instantiate(NoBreakBlock, new Vector3(x - 8.4f, y, 0.0f), Quaternion.identity);
        ...
        Instantiate(NoBreakBlock, new Vector3(x + 2.4f, y + 1.2f, 0.0f), Quaternion.identity);
        ...
        Instantiate(BreakBlock, new Vector3(x + 6.0f, y + 3.6f, 0.0f), Quaternion.identity);
        ...
        Instantiate(BreakBlock, new Vector3(x + 4.8f, y + 4.8f, 0.0f), Quaternion.identity);
        Instantiate(BreakBlock, new Vector3(x + 6.0f, y + 4.8f, 0.0f), Quaternion.identity);
        ...
        Instantiate(BreakBlock, new Vector3(x - 4.8f, y + 4.8f, 0.0f), Quaternion.identity);
        Instantiate(BreakBlock, new Vector3(x - 6.0f, y + 4.8f, 0.0f), Quaternion.identity);
        Instantiate(BreakBlock, new Vector3(x - 7.2f, y + 4.8f, 0.0f), Quaternion.identity);
        Instantiate(NoBreakBlock, new Vector3(x - 8.4f, y + 4.8f, 0.0f), Quaternion.identity);

        //6段目
        Instantiate(NoBreakBlock, new Vector3(x, y + 6.0f, 0.0f), Quaternion.identity);
        Instantiate(NoBreakBlock, new Vector3(x + 1.2f, y + 6.0f, 0.0f), Quaternion.identity);
        ...
        Instantiate(BreakBlock, new Vector3(x + 6.0f, y + 6.0f, 0.0f), Quaternion.identity);
        ...
        Instantiate(BreakBlock, new Vector3(x - 7.2f, y + 6.0f, 0.0f), Quaternion.identity);
        ...
        Instantiate(BreakBlock, new Vector3(x + 6.0f, y + 7.2f, 0.0f), Quaternion.identity);
