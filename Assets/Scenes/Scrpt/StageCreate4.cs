...
public class StageCreate4 : MonoBehaviour
{
    //初期値
    float x = 0.6f;
    float y = -2.0f;
    ...
    void Start()
    {
        ...
        Instantiate(NoBreakBlock, new Vector3(x - 6.0f, y + 1.2f, 0.0f), Quaternion.identity);
        Instantiate(BreakBlock, new Vector3(x - 7.2f, y + 1.2f, 0.0f), Quaternion.identity);
        Instantiate(BreakBlock, new Vector3(x - 8.4f, y + 1.2f, 0.0f), Quaternion.identity);
        ...
        Instantiate(BreakBlock, new Vector3(x + 7.2f, y + 2.4f, 0.0f), Quaternion.identity);
        ...
        Instantiate(BreakBlock, new Vector3(x - 8.4f, y + 2.4f, 0.0f), Quaternion.identity);
        ...
        Instantiate(BreakBlock, new Vector3(x - 8.4f, y + 4.8f, 0.0f), Quaternion.identity);
        ...
        Instantiate(BreakBlock, new Vector3(x + 4.8f, y + 6.0f, 0.0f), Quaternion.identity);
        ...
        Instantiate(NoBreakBlock, new Vector3(x - 6.0f, y + 6.0f, 0.0f), Quaternion.identity);
        Instantiate(BreakBlock, new Vector3(x - 7.2f, y + 6.0f, 0.0f), Quaternion.identity);
        Instantiate(BreakBlock, new Vector3(x - 8.4f, y + 6.0f, 0.0f), Quaternion.identity);
