...
public class StageCreate2 : MonoBehaviour
{
    ...
    {
        //1段目
        Instantiate(NoBreakBlock, new Vector3(x, y, 0.0f), Quaternion.identity);
        Instantiate(NoBreakBlock, new Vector3(x + 1.2f, y, 0.0f), Quaternion.identity);
        ...
        //2段目
        Instantiate(NoBreakBlock, new Vector3(x, y + 1.2f, 0.0f), Quaternion.identity);
        Instantiate(NoBreakBlock, new Vector3(x + 1.2f, y + 1.2f, 0.0f), Quaternion.identity);
